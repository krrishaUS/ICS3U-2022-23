...
public class ForLoopExamples {
   public static void main(String[] args) {
      //exampleOne();
      //exampleTwo(1, 1000);
      System.out.println(exampleThree("Check this String"));
    
   }

   /* Introduction to for loops (counting loops) */
   private static void exampleOne() {
/* For loop is meant to iterate through a collection when there are indexes - like Strings. for loop is 
 * a counting loop
 */
